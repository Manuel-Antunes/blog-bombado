...
export const SuccessToast: React.FC<ToastProps> = ({ dismiss, message }) => {
  return (
    <div className="w-80 border-l-4 z-50 border-green-400 bg-green-50 p-4 text-sm flex items-center shadow-lg relative">
      <button
        type="button"
...
export const InfoToast: React.FC<ToastProps> = ({ dismiss, message }) => {
  return (
    <div className="w-80 border-l-4 z-50 border-blue-400 bg-blue-50 p-4 text-sm flex items-center shadow-lg relative">
      <button
        type="button"
...
export const WarningToast: React.FC<ToastProps> = ({ dismiss, message }) => {
  return (
    <div className="w-80 border-l-4 z-50 border-yellow-400 bg-yellow-50 p-4 text-sm flex items-center shadow-lg relative">
      <button
        type="button"
...
export const DangerToast: React.FC<ToastProps> = ({ dismiss, message }) => {
  return (
    <div className="w-80 border-l-4 z-50 border-red-400 bg-red-50 p-4 text-sm flex items-center shadow-lg relative">
      <button
        type="button"
